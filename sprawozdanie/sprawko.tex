...
%TODO Uzupełnić jak się wyjaśni problem z lipa40a i lipa50a
...
Implementacja Tabu Search wymagała oceny każdego z sąsiadów przy każdej iteracji, co okazało się bardzo kosztowne.
...
Wykres z Rys.\ref{fig:qualitytimefullMETA} pozwala na ocenę algorytmów SA i TS.
...
Rozwiązania znajdowane przez Symulowane Wyżarzanie są zdecydowanie gorsze niż~przez pozostałe algorytmy.
...
Może to~wynikać z~narzuconych warunków - brak poprawy przez liczbę kroków równą dziesięciokrotności rozmiaru sąsiedztwa. 
